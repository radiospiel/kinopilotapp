...
#define assert_equal_objects(a, e)  m3_assert([(a) isEqual: (e)], m3_msg(@"%@ should equal %@", [a inspect], [e inspect]))

#define assert_not_equal_pod(a, e)      m3_assert((a != e),           m3_msg(@"'%s' should not equal '%s'", #a, #e))
#define assert_not_equal_objects(a, e)  m3_assert(![(a) isEqual: (e)], m3_msg(@"%@ should not equal %@", [a inspect], [e inspect]))

...
#define assert_equal(a, e)          m3_assert([_.object(a) isEqual: _.object(e)],   m3_msg(@"%@ should be equal to %@", (a), (e)))
#define assert_not_equal(a, e)      m3_assert(![_.object(a) isEqual: _.object(e)],  m3_msg(@"%@ should not be equal to %@", (a), (e)))
